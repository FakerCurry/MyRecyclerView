...
//            notifyItemRangeChanged(0+offest, datas.size());
    ...
    public void setItemLongClickListener(BasicRecyViewHolder.OnItemLongClickListener longClickListener) {
        this.longClickListener = longClickListener;
    }

    public void setItemClickListener(BasicRecyViewHolder.OnItemClickListener clickListener) {
        this.clickListener = clickListener;
    }

    public void setLongClickListener(BasicRecyViewHolder.OnItemLongClickListener longClickListener) {
        this.longClickListener = longClickListener;
    }

    public void setHeadClickListener(BasicRecyViewHolder.OnHeadViewClickListener headClickListener) {
        this.headClickListener = headClickListener;
    }

    public void setFootClickListener(BasicRecyViewHolder.OnFootViewClickListener footClickListener) {
        this.footClickListener = footClickListener;
    }

    public void setHeadLongClickListener(BasicRecyViewHolder.OnHeadViewLongClickListener headLongClickListener) {
        this.headLongClickListener = headLongClickListener;
    }

    public void setFootLongClickListener(BasicRecyViewHolder.OnFootViewLongClickListener footLongClickListener) {
