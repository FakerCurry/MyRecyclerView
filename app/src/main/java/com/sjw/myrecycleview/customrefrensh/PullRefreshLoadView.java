 ...
 */
public class PullRefreshLoadView extends LinearLayout implements IPullRefreshView {
...
//        LayoutInflater.from(getContext()).inflate(R.layout.hf_rv_refresh, null);
        inflate(context, R.layout.hf_rv_refresh, this);
...
//        mLoader = (BallSpinFadeLoader) mContainer.findViewById(R.id.ball_loader);
        ...
        mStatusTv = (TextGradientView) findViewById(R.id.tv_refresh_status);
        mLoader = (BallSpinFadeLoader) findViewById(R.id.ball_loader);
